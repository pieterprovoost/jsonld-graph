var jsonldviz = (function (exports, d3, jsonld) {
  ...
  function _generateGraph() {
    _generateGraph = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(input) {
      var regex, cleaned, parsed, expanded, nodes, links, addNode, addLink, recursiveTraversal, nodeIds, jsonGraph;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            regex = /\/\*[\s\S]*?\*\/|\s\/\/.*\n/g;
            cleaned = input.replaceAll(regex, "");
            parsed = JSON.parse(cleaned);
            _context.next = 8;
            return jsonld.expand(parsed);
          case 8:
