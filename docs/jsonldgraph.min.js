var jsonldgraph = (function (exports, d3, jsonld) {
  'use strict';
  ...
  var JsonldGraph = /*#__PURE__*/function () {
    function JsonldGraph(config, data) {
      _classCallCheck(this, JsonldGraph);
      this.config = {
  ...
  function _generateGraph() {
    _generateGraph = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(input) {
      var expanded, nodes, links, addNode, addLink, _iterator, _step, node, _iterator2, _step2, item, _iterator3, _step3, _item, _iterator4, _step4, _item2, _iterator5, _step5, _item3, _iterator6, _step6, _item4, nodeIds, jsonGraph;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            nodes = {};
            links = [];
            _iterator = _createForOfIteratorHelper(expanded);
            try {
              for (_iterator.s(); !(_step = _iterator.n()).done;) {
                ...
                if ("http://schema.org/parentOrganization" in node) {
                  _iterator2 = _createForOfIteratorHelper(node["http://schema.org/parentOrganization"]);
                  try {
                ...
                if ("http://schema.org/about" in node) {
                  _iterator3 = _createForOfIteratorHelper(node["http://schema.org/about"]);
                  try {
                ...
                if ("http://schema.org/author" in node) {
                  _iterator4 = _createForOfIteratorHelper(node["http://schema.org/author"]);
                  try {
                    for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
                      _item2 = _step4.value;
                      addNode(nodes, _item2);
                      addLink(links, {
                        source: node["@id"],
                        target: _item2["@id"],
                        type: "author"
                ...
                if ("http://schema.org/includedInDataCatalog" in node) {
                  _iterator5 = _createForOfIteratorHelper(node["http://schema.org/includedInDataCatalog"]);
                  try {
                    for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
                      _item3 = _step5.value;
                      addNode(nodes, _item3);
                      addLink(links, {
                        source: node["@id"],
                        target: _item3["@id"],
                ...
                if ("http://schema.org/variableMeasured" in node) {
                  _iterator6 = _createForOfIteratorHelper(node["http://schema.org/variableMeasured"]);
                  try {
                    for (_iterator6.s(); !(_step6 = _iterator6.n()).done;) {
                      _item4 = _step6.value;
                      addNode(nodes, _item4);
                      addLink(links, {
                        source: node["@id"],
                        target: _item4["@id"],
